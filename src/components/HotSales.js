...
// export function HotSales(props) {

//     return (
//         <React.Fragment>
//             <div className="container-fluid">
//                 <img src={image} className="img-fluid" style={{width:'100%', height:'600px'}} alt=""/>
//                 <div className="row">
//                     <div className="col">
//                     </div>
//                 </div>
...
const Allproducts =(props)=> {
    ...
    useEffect(()=>{
        ...
        const fetchProductDetails = async ()=>{
            try{
                const fetchProduct = await axiosClient.get(`${url}/${products._id}`)
                        ...
                        if(item.bestSeller){
                            return(
                                <React.Fragment key={item._id}>
                                    <div className="col-12 mx-auto col-md-6 col-lg-3 col-sm-6 my-2" onClick={handleShow} >
                                        <Card className="p-2 cardBodyHotSale">
                                            <Card className="p-3">
                                                <Card.Img variant="top" src={item.productImageUrl} className="imageSizing position-relative" />
                                                <h2 ><span className="position-absolute" style={{ backgroundColor:'#BC1F27', color:"#fff", float:'right', right:'16px', top:"0px",padding:"7px"}}> Best Seller </span> </h2>
                                            </Card>
                                            <Card.Body>
                            ...
                            return(
                            <React.Fragment key={item._id}>
                                <div className="col-12 mx-auto col-md-6 col-lg-3 col-sm-6 my-2" onClick={handleShow} key={item._id} >
